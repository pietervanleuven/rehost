...
func (Static) EnableMaintenance(context.Context, Host, detect.Install) (MaintenanceResult, error) {
	return staticNoop(), nil
}

func (Static) DisableMaintenance(context.Context, Host, detect.Install) (MaintenanceResult, error) {
	return staticNoop(), nil
}

func (Static) MaintenanceStatus(context.Context, Host, detect.Install) (MaintenanceState, error) {
