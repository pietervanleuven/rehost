// Package dns takes a read-only snapshot of a domain's public records —
// A/AAAA, CNAME, MX, NS, TXT with their TTLs — for migration tooling that
// reports on DNS but never changes it.
package dns
